...
const medicineProducts: Product[] = [
  ...
  // ผิวหนัง / แมลงกัดต่อย
  { name: "ยาทาเสลดพังพอน ชนิดตลับ", unit: "ตลับ" },
  { name: "คาดรามีน-วี โลชั่น (Cadramine-V Lotion)", unit: "ขวด", sizeLabel: "60 มล." },
  { name: "คาลาไมน์ โลชั่น (Calamine Lotion)", unit: "ขวด" },
  { name: "คาลาไมน์พญายอ", unit: "ขวด" },
  { name: "คาเนสเทน ยาครีมฆ่าเชื้อรา (Canesten)", unit: "หลอด", sizeLabel: "10 กรัม" },
  { name: "ไลมาริน ครีม (Lymarin Cream)", unit: "หลอด", sizeLabel: "15 กรัม" },
  { name: "คีล่า โลชั่น (Kela Lotion)", unit: "ขวด" },
  { name: "เบต้า-ไดโป ครีม (Beta-Dipo Cream)", unit: "หลอด", sizeLabel: "10 กรัม" },
  { name: "ฟังจิเดอร์ม-บี ครีม (Fungiderm-B Cream)", unit: "หลอด", sizeLabel: "20 กรัม" },
  { name: "ซีมา ครีม รักษาฮ่องกงฟุต (Zema Cream)", unit: "หลอด", sizeLabel: "10 กรัม" }
].map((product, index) => ({
  id: 14000 + index,
